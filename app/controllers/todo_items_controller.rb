class TodoItemsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @todo_item.update(todo_item_params)
        format.html { redirect_to root_path, notice: 'Todo item was successfully updated.' }
  ...
  def destroy
    @todo_item.destroy
    respond_to do |format|
      format.html { redirect_to root_path, notice: 'Todo item was successfully destroyed.' }
